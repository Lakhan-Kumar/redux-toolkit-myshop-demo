  ...
  return (
    <div className='cart-container'>
        <div className='cart-header'>
                    ...
                    <div key={item.id} className='cart-item'>
                        ...
                        <div className='item-actions'>
                            <div style={{display:'flex'}}>
                                <input onChange={(event)=>manageQuantity(item.id,event.target.value)} value={item.quantity?item.quantity:1}  style={{margin:'15px'}} type="number" placeholder='enter quantity' />
                                <div>
            ...
            <button onClick={handelPlaceOrder} className='btn'>Place Order</button>
    </div>
  )
}
